function ActualizarPassNew(){

	$("#pass_actual_bloq").removeClass('valPass');

	pass_actual = $("#pass_actual_bloq").val();
	pass_new = $("#pass_new_bloq").val();
	pass_new_confirm = $("#pass_new_confirm_bloq").val();
	...
	if(pass_new != pass_new_confirm){
		...
		$("#pass_new_bloq").addClass('valPass');
		$("#pass_new_confirm_bloq").addClass('valPass');
		return 0;
	}else{
		$("#pass_new_bloq").removeClass('valPass');
		$("#pass_new_confirm_bloq").removeClass('valPass');
	}
	...
	type: 'POST',
		success:function(R){
			if(R == 1){
				...
				$("#pass_actual_bloq").val('');
				$("#pass_new_bloq").val('');
				$("#pass_new_confirm_bloq").val('');
				$("#pswd_info2").hide();
				$("#modal-ActualizarPass_bloq").modal('hide');
			}else if(R == 2){
				Swal.fire("La contraseña actual es incorrecta", "", "warning");
				$("#pass_actual_bloq").addClass('valPass');
			}else{
