...
//$url = 'http://localhost/CUN/formularioback/Admin/PerfilList.php';
$url = 'http://190.184.202.251:8090/formularioback/Admin/PerfilList.php';
 ...
 ?>
	...
	<tr>
        ...
        <td>
            ...
            <input type="button" class="btn btn-danger" value="Quitar Perfil" onclick="QuitPerfilEmpleado(<?php echo $empleado['ID']; ?>);">
