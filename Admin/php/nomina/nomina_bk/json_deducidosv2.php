...
function DyD_deducciones($periodo,$nmro_identificacion,$nmro_cuenta,$conceptos_DyD){

	//Sacar del array de conceptos, solo lo que pertenece al empleado

	$conceptos_empleado = ExtraerConceptosDyDU($nmro_identificacion,$nmro_cuenta,$conceptos_DyD);

	//Sacar el nivel1 de los conceptos

	$conceptos_nivel1 = ExtraerNivel1DyDU($conceptos_empleado);
	...
	foreach($conceptos_nivel1 as $key1){
		...
		$array_nivel2 = ExtraerNivel2DyDU($conceptos_empleado,$nombre_nivel1);
		$valor_nivel1 = array();
		...
		foreach($array_nivel2 as $key2){
			...
			//Consultar nivel 3
			$array_nivel3 = ExtraerNivel3DyDU($conceptos_empleado,$nombre_nivel1,$nombre_nivel2);
			$valor_nivel2 = array();
...
function ExtraerConceptosDyDU($nmro_identificacion,$nmro_cuenta,$conceptos_DyD){
...
function ExtraerNivel1DyDU($conceptos_DyD){
...
function ExtraerNivel2DyDU($conceptos_DyD,$nivel1_txt){
...
function ExtraerNivel3DyDU($conceptos_DyD,$nivel1_txt,$nivel2_txt){
